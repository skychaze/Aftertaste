...
Open the Today tab and scroll below the listening summary. The card stays between the summary and track feed.

## Driving it with adb

1. Launch. Exercise the help dialog with "App Info" and "Got It" if it is part of this drive.
2. Empty state: card reads "Ready to track", "Nothing playing yet", and "Play music to start tracking".
...
7. Button: tap `content-desc` "Open YouTube Music". Verify that YouTube Music opens.
